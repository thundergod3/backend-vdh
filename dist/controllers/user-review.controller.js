...
let UserReviewController = class UserReviewController {
    ...
    async find(id, filter) {
        return this.userRepository.y(id).find(filter);
    }
    async create(id, review) {
        return this.userRepository.y(id).create(review);
    }
    async patch(id, review, where) {
        return this.userRepository.y(id).patch(review, where);
    }
    async delete(id, where) {
        return this.userRepository.y(id).delete(where);
    }
};
tslib_1.__decorate([
    rest_1.get('/users/{id}/reviews', {
        responses: {
            '200': {
                description: 'Array of User has many Review',
                content: {
                    'application/json': {
...
], UserReviewController.prototype, "find", null);
tslib_1.__decorate([
    rest_1.post('/users/{id}/reviews', {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], UserReviewController.prototype, "create", null);
tslib_1.__decorate([
    rest_1.patch('/users/{id}/reviews', {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], UserReviewController.prototype, "patch", null);
tslib_1.__decorate([
    rest_1.del('/users/{id}/reviews', {
        responses: {
            '200': {
...
UserReviewController = tslib_1.__decorate([
